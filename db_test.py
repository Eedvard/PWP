...
def test_edit_nutri(db_handle):
    ...
    test = NutritionInformation.query.first() #change NutritionInformation id
    test.id = 2
    db_handle.session.commit()
    ...
    test2 = Ingredient.query.first() #change Ingredient id
    test2.id = 3
    db_handle.session.commit()
    ...
    test3 = Recipe.query.first() #change Recipe id
    test3.id = 4
    db_handle.session.commit()
    ...
    test4 = Meal.query.first() #change Meal id
    test4.id = 5
    db_handle.session.commit()
    ...
    test7 = WeeklyPlan.query.first() #change WeeklyPlan id
    test7.id = 8
    db_handle.session.commit()
...
def test_measurement_ondelete_ingredient(db_handle): #delete Ingredient
...
def test_measurement_ondelete_recipe(db_handle): #delete Recipe
...
def test_measurement_ondelete_mealplan(db_handle): #delete MealPlan
    nutri, ingredient, recipe, recipei, recipestep, shoplist, shoplisti, user, weekplan, mealplan, meal, mealrecipe, like = createdb(db_handle)
...
def test_measurement_ondelete_shoplist(db_handle): #delete ShopList
...
def test_measurement_ondelete_user(db_handle): #delete User
...
def test_measurement_ondelete_weekplan(db_handle): #delete WeekPlan
...
def test_measurement_ondelete_meal(db_handle): #delete Meal
